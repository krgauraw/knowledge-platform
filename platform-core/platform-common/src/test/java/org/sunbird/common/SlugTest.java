...
public class SlugTest {
	...
	@Test
	public void testMakeSlugWithTransliterate() {

	}

	@Test
	public void testMakeSlugWithSpaces() {
		// Single space
	...
	@Test
	public void testMakeSlugWithSpecialChars() {
	...
	@Test
	public void testMakeSlugWithUrlChars() {
	...
	@Test
	public void testMakeSlugWithAccentChars() {
	...
	@Test
	public void testMakeSlugWithTransliteration() {

		String name = "keyboard.css###^^^";
		String expected = "keyboard.css";
		String slug = Slug.makeSlug(name, true);
		assertEquals("File extension not correctly handled", expected, slug);

		// Hindi
		name = "हाथी और भालू की शादी";
		expected = "haathii-aur-bhaaluu-kii-shaadii";
	...
	@Test
	public void testMakeSlugWithInvalidValue() {
